...
const ImportForm = ({ getData, setError, openImportUserForm, handleCloseImportUserForm, logout }) => {
    ...
    const handleSubmit = (event) => {
        ...
        data.append("dep", dep);
        data.append("updateUsers", Update);
    ...
    return (
        <React.Fragment>
            {/* <Button onClick={handleOpenImportUserForm}>Open modal</Button> */}
            <Modal
                open={openImportUserForm}
                onClose={handleCloseImportUserForm}
            ...
            >
                <Box component="form" onSubmit={handleSubmit} noValidate sx={style}>
                    ...
                    > ت او id, الاسم
                        <span style={{ fontWeight: 'bold' }}> مطلوب*</span> </Alert>
                    {/* <Typography id="modal-modal-title" variant="h6" component="h2">
                        Import user and salaries
                    </Typography> */}
                    <FormControl size="small" sx={{ m: 1, mt: 2, width: 400 }}>
                        <Autocomplete
                    ...
                    <FormControl sx={{ m: 1, width: 400 }}>
                        <FormControlLabel control={<Switch
                            ...
                            label="Date desktop"
                            name="on"
                            defaultChecked />} label="تحديث معلومات الموظف" />
                    </FormControl>
                    <Button
                        type="submit"
                        variant="contained"
                    ...
                    <a href={Docc} download="doc">
                        <Button className="linksss" variant="contained" sx={{ width: 400, m: 1 }}>
                            قم بتنزيل ملف فارغ
                        </Button>
                    </a>
                </Box>
